            ...
            <div class="container pt-4">
                ...
                <div class="row">
                    ...
                    <div class=" col-4  p-4 border  mx-5 rounded bg-white">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control text-start" id=""
                    ...
                    <div class="col-4   p-4 rounded border text-center  bg-white">
                        ...
                        <button type="button" class="btn btn-outline-success text-center"><a
                                class="navbar-brand text-success" href="{{ url('/register') }}">S'inscrire</a></button>
