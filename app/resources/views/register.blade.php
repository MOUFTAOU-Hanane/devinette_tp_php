    ...
    <body class = "">
        <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav ms-auto">
                                <li class="nav-item "><a class="nav-link active text-white" aria-current="page"
                                        href="{{ url('/SHOW')}}">Se connecter</a></li>
                                <li class="nav-item"><a class="nav-link text-white" href="{{ url('/home')}}">S'inscrire</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
            ...
            <hr>
            <div class="container">
                <h4 class="text-center text-white pb-4">S'inscrire</h4>
